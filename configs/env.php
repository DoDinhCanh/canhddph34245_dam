...
define('BASE_URL',          'http://localhost/canhddph34245_DAM/');
define('BASE_URL_ADMIN',          'http://localhost/canhddph34245_DAM/?mode=admin');
...
define('DB_PASSWORD', '');
define('DB_NAME',     'canhddph34245_web2041.04');
define('DB_OPTIONS', [
